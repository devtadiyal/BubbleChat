...
//        });
    ...
    public void invite() {
        String shareBody = "Join me on Kakaki Express, this free video chat and messaging app is amazing. I like it! http://play.google.com/store/apps/details?id=com.kakaexpress\n";
        Intent sharingIntent = new Intent(android.content.Intent.ACTION_SEND);
        sharingIntent.setType("text/plain");
        sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "Kakaki Express Invite");
...
//        }
    ...
    private void showOkDialog(String msg) {
        ...
        dialogBuilder.setTitle("Kakaki Express");
